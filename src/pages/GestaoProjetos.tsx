...
export default function Projeto({ projeto }: ProjetoProps) {
  ...
  return (
    <ProjetoContainer>
        <Head>
          <title>Gestão de Projetos | Qualifik Engenharia e Consultoria</title>
          <meta
            name="description"
      ...
      <BannerProjeto
          ...
          imgUrl="https://i.ibb.co/5jxSJfZ/engenheiro-de-arquitetos-discutindo-na-mesa-com-planta-23-2147842977.webp"
      />
